...
import com.lolkek.contactlist.utils.getLongValue
import com.lolkek.contactlist.utils.getStringValue
...
class ContactsHelper(
    ...
    private fun mergePhoneNumbers1(contacts: List<ContactModel>): ContactModel {
        val first = contacts.first()
        val phoneNumbers = first.phoneNumbers.toMutableSet()
        contacts.forEachIndexed { i, contactModel ->
            if (i > 0) {
